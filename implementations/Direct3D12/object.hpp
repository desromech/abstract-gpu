#ifndef _AGPU_D3D12_OBJECT_HPP_
#define _AGPU_D3D12_OBJECT_HPP_

#include <atomic>
#include <assert.h>
#include "common.hpp"

extern "C" agpu_icd_dispatch agpu_d3d12_icd_dispatch;
...
public:
    Object()
        : dispatch(&agpu_d3d12_icd_dispatch), refcount(1)
    {
    }
