...
inline VkImageLayout mapTextureUsageModeToLayout(agpu_texture_usage_mode_mask allAllowedUsages, agpu_texture_usage_mode_mask mode)
{
	...
	case AGPU_TEXTURE_USAGE_COPY_SOURCE: return VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL;
	case AGPU_TEXTURE_USAGE_COPY_DESTINATION: return VK_IMAGE_LAYOUT_TRANSFER_SRC_OPTIMAL;
