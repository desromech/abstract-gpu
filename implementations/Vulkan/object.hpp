#ifndef _AGPU_VULKAN_OBJECT_HPP_
#define _AGPU_VULKAN_OBJECT_HPP_

#include <atomic>
#include <assert.h>
#include "common.hpp"

extern "C" agpu_icd_dispatch agpu_vulkan_icd_dispatch;
...
public:
    Object()
        : dispatch(&agpu_vulkan_icd_dispatch), refcount(1)
    {
    }
