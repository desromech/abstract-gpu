#ifndef _AGPU_METAL_OBJECT_HPP_
#define _AGPU_METAL_OBJECT_HPP_

#include <atomic>
#include <assert.h>
#include "common.hpp"

extern "C" agpu_icd_dispatch agpu_metal_icd_dispatch;
...
public:
    Object()
        : dispatch(&agpu_metal_icd_dispatch), refcount(1)
    {
    }
