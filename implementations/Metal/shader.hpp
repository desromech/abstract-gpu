...
public:
    ...
    agpu_error getOrCreateShaderInstanceForSignature(agpu_shader_signature *signature, agpu_uint vertexBufferCount, std::string *errorMessage, agpu_shader_forSignature **result);
    agpu_error getOrCreateSpirVShaderInstanceForSignature(agpu_shader_signature *signature, agpu_uint vertexBufferCount, std::string *errorMessage, agpu_shader_forSignature **result);
