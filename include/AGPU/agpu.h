...
typedef agpu_error (*agpuSetAlphaTestingState_FUN) ( agpu_pipeline_builder* pipeline_builder, agpu_bool enable, agpu_compare_function function );
typedef agpu_error (*agpuSetRenderTargetCount_FUN) ( agpu_pipeline_builder* pipeline_builder, agpu_int count );
typedef agpu_error (*agpuSetPrimitiveTopology_FUN) ( agpu_pipeline_builder* pipeline_builder, agpu_primitive_mode topology );
...
typedef agpu_error (*agpuSetUniformi_FUN) ( agpu_command_list* command_list, agpu_int location, agpu_size count, agpu_int* data );
typedef agpu_error (*agpuSetUniform2i_FUN) ( agpu_command_list* command_list, agpu_int location, agpu_size count, agpu_int* data );
typedef agpu_error (*agpuSetUniform3i_FUN) ( agpu_command_list* command_list, agpu_int location, agpu_size count, agpu_int* data );
typedef agpu_error (*agpuSetUniform4i_FUN) ( agpu_command_list* command_list, agpu_int location, agpu_size count, agpu_int* data );
typedef agpu_error (*agpuSetUniformf_FUN) ( agpu_command_list* command_list, agpu_int location, agpu_size count, agpu_float* data );
typedef agpu_error (*agpuSetUniform2f_FUN) ( agpu_command_list* command_list, agpu_int location, agpu_size count, agpu_float* data );
typedef agpu_error (*agpuSetUniform3f_FUN) ( agpu_command_list* command_list, agpu_int location, agpu_size count, agpu_float* data );
typedef agpu_error (*agpuSetUniform4f_FUN) ( agpu_command_list* command_list, agpu_int location, agpu_size count, agpu_float* data );
typedef agpu_error (*agpuSetUniformMatrix2f_FUN) ( agpu_command_list* command_list, agpu_int location, agpu_size count, agpu_bool transpose, agpu_float* data );
...
typedef struct _agpu_icd_dispatch {
	...
	agpuSetAlphaTestingState_FUN agpuSetAlphaTestingState;
